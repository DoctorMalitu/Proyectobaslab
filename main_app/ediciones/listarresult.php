...
$dbho = new conexionbs();
if(isset($_GET['documentoresult']) || isset($_GET['fecha_naci'])){

    $documentoresult =mysqli_real_escape_string($dbho, htmlentities( $_GET['documentoresult']));
    $fecha_naci =mysqli_real_escape_string($dbho, htmlentities( $_GET['fecha_naci']));
//    print($fecha_naci); 
